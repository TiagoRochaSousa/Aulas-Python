...
def procurar_livro(proli, op_procurar, emprestimo_devolucao=False, status=""):
    ...
    if len(proli) == 0:
        ...
        while True:
            ...
            if emprestimo_devolucao is True and len(pesquisa_biblio) == 0 and available_data == 0:
                return
...
biblioteca = [
    {
        'Título': 'The Hobbit', 'Autores': [['Tolkien']], 'ISBN': '9789721043053', 'Ano de publicação': '1937', 'Editora': 'Publicações Europa-América',
        'Categorias': [['Fantasia']], 'Status': 'Disponível'
    },
    {
        'Título': 'Cujo', 'Autores': [['Stephen King']], 'ISBN': '9781444708127', 'Ano de publicação': '2008', 'Editora': 'HODDER & STOUGHTON',
        'Categorias': [['terror']], 'Status': 'Disponível'
    }
    ]
